...
export default function UserMenu({ user }: UserMenuProps) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {isMenuOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-popover border border-border rounded-lg shadow-xl overflow-hidden animate-fadeIn">
          ...
          <div className="py-2">
            <button className="w-full px-4 py-2.5 text-left text-sm text-foreground hover:bg-muted transition-colors flex items-center gap-3 cursor-pointer">
